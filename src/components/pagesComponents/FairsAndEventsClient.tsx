  ...
  return (
    <div className="w-full bg-white dark:bg-[#0a0a0a] text-neutral-900 dark:text-neutral-100 transition-colors duration-200 overflow-hidden">
      ...
      <section
        ...
        className="relative w-full py-24 px-4 sm:px-6 lg:px-8 bg-neutral-50 dark:bg-[#0e0e0e] border-t border-neutral-200/80 dark:border-neutral-800/80 transition-colors duration-200"
      >
        <div className="max-w-7xl mx-auto">
          {/* Cabeçalho da seção */}
          <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
            {content.stepsSection.steps.map((st, idx) => {
              const StepIcon =
                idx === 0
                  ? FileText
                  : idx === 1
              ...
              return (
                <div
                  key={idx}
                  className="relative rounded-2xl p-6 sm:p-7 bg-white dark:bg-neutral-900/90 border border-neutral-200/90 dark:border-neutral-800/80 shadow-md dark:shadow-lg flex flex-col justify-between hover:border-orange-500/50 hover:bg-neutral-50 dark:hover:bg-neutral-850 transition-all duration-300"
                >
                  <div>
      ...
      <section className="relative w-full py-24 sm:py-32 px-4 sm:px-6 lg:px-8 overflow-hidden bg-[#060606] border-t border-neutral-800/80">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center flex flex-col items-center">
          ...
          <p className="mt-4 text-xs text-neutral-300">{content.cta.disclaimer}</p>
        </div>
      </section>
    </div>
  );
