          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
            {content.stepsSection.steps.map((step, idx) => {
              ...
              return (
                <div
                  key={step.num}
                  className="relative rounded-2xl p-6 sm:p-7 bg-white/90 dark:bg-neutral-900/90 border border-neutral-200/90 dark:border-neutral-800/80 shadow-md dark:shadow-lg flex flex-col justify-between hover:border-orange-500/50 transition-all duration-300"
                >
                  <div>
